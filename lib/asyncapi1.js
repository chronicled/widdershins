...
const refParser = common.refParser;
const pushDir = common.pushDir;
const popDir = common.popDir;
const derefAll = common.derefAll
...
function convertInner(rootSpec, subSpecs, options, callback) {
    let data = {};
    if (options.verbose) console.warn('starting deref', rootSpec);
    const derefOpts = {};
